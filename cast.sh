...
$RECORDER -f $AUDIO -ac $CHANNELS -i $SOUNDCARD -f x11grab -r $FPS -s $FULLSCREEN -i $XDISP -vcodec libx264 -preset $PRESET -crf $CRF -acodec $ACODEC -ab 128k -threads $THREADS $DIRECTORY$FILENAME
